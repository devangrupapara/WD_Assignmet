...
let alldeta = JSON.parse(localStorage.getItem("catInfo"))
let k = 2
alldeta.map((i) => {
...
let hr = `          <div id="tab-1" class="tab-pane fade show p-0 active">
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    <div class="row g-4">
...
k = 2
let allhrdeta = JSON.parse(localStorage.getItem('prInfo'))
alldeta.map((i) => {
    hr += `  <div id="tab-${k++}" class="tab-pane fade show p-0">
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    <div class="row g-4">`
    allhrdeta.map((j) => {
        if (i.id == j.catProName) {
            hr += `<div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="rounded position-relative fruite-item">
                                                <div class="fruite-img">
